...
if(!localStorage.itemList){
   let itemList = [
      ...
      new Product('https://fmstyle.com.vn/images/products/782831_1566180176_2201VDUFMF2203---2.jpg', 'Váy trơn', 'skirt', 349),
      ...
      $('product').innerHTML += `
         <div class="item ${item.type}">
            ...
            <div class="buy">
               ...
               <i class="addCart-btn fa-solid fa-cart-plus" onclick="addCart(${i},event)"></i>
            </div>
         </div> 
      `
   })
